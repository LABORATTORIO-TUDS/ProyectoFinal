...
public class VistaProyeccion extends javax.swing.JPanel {
    ...
    public VistaProyeccion() {
        ...
        jTabla.getSelectionModel().addListSelectionListener(e -> {
         ...
         String[] columnas = {"Código", "Titulo", "Director", "Fecha", "Inicio", "Fin", "$$", "Sala", "3D", "sub", "idioma"};
    ...
    public void cargarTablaProyecciones() {
        ...
        System.out.println("Cantidad de proyecciones traídas de BD: " + proy.size());
    ...
    private void crearProyeccion() {
        try {
            ...
            Proyeccion proy = new Proyeccion(idioma, es3D, subtitulada, horaInicio, horaFin, precio, peli.getTitulo(), peli.getDirector(), salita.getNroSala(), fecha);

            //Ahora le metemos el objeto que creamos bien adentro de la base de datoss
           int res = proyD.crearProyeccion(proy);

            proyD.generarAsientos(res, salita.getCapacidad());
    ...
    public void editarProyeccion() {
        ...
        try {
            ...
            String titulo = (String) jTabla.getValueAt(filaSel, 1);
            String director = (String) jTabla.getValueAt(filaSel, 2);
            int nroSala = (int) jTabla.getValueAt(filaSel, 7);
            ...
            jTFCodProyeccion.setText(String.valueOf(codigo));
             jdcFecha.setDate( (Date)jTabla.getValueAt(filaSel, 3) );

            // Idioma
            String idioma = (String) jTabla.getValueAt(filaSel, 10);
            jCBIdiomas.setSelectedItem(idioma);

            // 3D y Subtitulada
            jCheckBox_Es3D.setSelected((boolean) jTabla.getValueAt(filaSel, 8));
            jCheckBox_EsSubtitulada.setSelected((boolean) jTabla.getValueAt(filaSel, 9));
    ...
    public void modificarProyeccion() {
        try {
            ...
            Proyeccion proyModificada = new Proyeccion(codProyeccion, idioma, es3D, subtitulada,
                    horaInicio, horaFin, precio, peli.getTitulo(), peli.getDirector(), salita.getNroSala(), fecha);
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 340, -1));

        jCBSalas.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        add(jCBSalas, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 70, 220, -1));
        ...
        jCBIdiomas.setSelectedIndex(-1);
        add(jCBIdiomas, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 110, 220, -1));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 650, 210));
        ...
        add(jdcFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, 220, -1));
