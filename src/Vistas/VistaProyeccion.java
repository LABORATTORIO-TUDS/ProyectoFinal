...
public class VistaProyeccion extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 30, 220, -1));
        ...
        jComboBox2.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 90, 220, -1));
        ...
        jComboBox3.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 220, -1));
        ...
        add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, -1, 20));
        ...
        jCheckBox2.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 12)); // NOI18N
        ...
        add(jCheckBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, 20, 20));
        ...
        add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 210, 70, -1));
        add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 640, 10));
        ...
        add(jSpinner2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 210, 70, -1));
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, -1, 40));

        jTextField1.setBackground(java.awt.SystemColor.controlLtHighlight);
        jTextField1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, 180, 30));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 610, 100, 50));

        jButton3.setText("Limpiar");
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 610, 100, 50));
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 600, 640, 10));
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 610, 100, 50));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 650, 220));

        jButton4.setText("Modificar");
        add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 610, 100, 50));
